    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=[("W", "Weekly"), ("M", "Monthly"), ("Q", "Quarterly")],
                        max_length=2,
                        null=True,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "editions",
                    models.ManyToManyField(related_name="issues", to="read.edition"),
                ),
                (
                    "periodical",
                    models.ForeignKey(
        ...
        migrations.AddField(
            ...
            name="persons",
            field=models.ManyToManyField(
                related_name="editions", through="read.EditionRole", to="entity.person"
            ),
        ),
        migrations.AddField(
            model_name="edition",
